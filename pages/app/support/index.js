...
export default function SupportForm(props) {
  ...
  return (
    <section id="contact-form">
      ...
      <div className="relative max-w-3xl pt-5 mx-auto md:px-2">
        <div className="w-full">
          <form onSubmit={handleSubmit}>
            <div className="grid w-full grid-cols-1 px-5 py-3 mx-auto sm:px-6 lg:px-6 gap-y-4 sm:grid-cols-2 sm:gap-x-8">
              ...
              <div className="col-span-2 sm:col-span-1">
                ...
                <div className="mt-1">
                  ...
                  />
                  <p className="py-2 text-sm bg-white">
